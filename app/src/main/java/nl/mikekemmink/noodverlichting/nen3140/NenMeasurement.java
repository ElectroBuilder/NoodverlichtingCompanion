...
public class NenMeasurement {
    ...
    public NenMeasurement(String id,
                          ...
                          long ts) {
        this.id = id;
        this.L1 = L1; this.L2 = L2; this.L3 = L3; this.N = N; this.PE = PE;
        this.timestamp = ts;
    }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            // relatievelden
            if (locationId != null) o.put("locationId", locationId);
            if (boardId != null) o.put("boardId", boardId);
    ...
    public static NenMeasurement fromJson(JSONObject o) {
        ...
        // relatievelden (EN + optionele NL fallback)
        m.locationId = o.optString("locationId", o.optString("locatieId", null));
        m.boardId    = o.optString("boardId",    o.optString("kastId", null));

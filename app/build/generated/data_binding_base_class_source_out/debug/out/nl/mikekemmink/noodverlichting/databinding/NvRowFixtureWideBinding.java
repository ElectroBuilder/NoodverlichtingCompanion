...
public final class NvRowFixtureWideBinding implements ViewBinding {
  @NonNull
  ...
  private NvRowFixtureWideBinding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static NvRowFixtureWideBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NvRowFixtureWideBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.nv_row_fixture_wide, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NvRowFixtureWideBinding bind(@NonNull View rootView) {

...
public final class ActivityFixtureListBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityFixtureListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFixtureListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_fixture_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFixtureListBinding bind(@NonNull View rootView) {

...
public final class NvGebrekBinding implements ViewBinding {
  @NonNull
  ...
  private NvGebrekBinding(@NonNull LinearLayout rootView, @NonNull ImageView imgThumb,
  ...
  @NonNull
  public static NvGebrekBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NvGebrekBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.nv_gebrek, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NvGebrekBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NvGebrekBinding((LinearLayout) rootView, imgThumb, tvDatum, tvOmschrijving);
    }

...
public final class ItemGebrekBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ItemGebrekBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemGebrekBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_gebrek, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemGebrekBinding bind(@NonNull View rootView) {
